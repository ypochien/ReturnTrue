...
public abstract class FixedFragmentStatePagerAdapter extends PagerAdapter
{
    ...
    public FixedFragmentStatePagerAdapter(JFragment fragmenet, String[] title)
    {
        mFragmentManager = fragmenet.getChildFragmentManager();
        this.title = title;
    }

    public FixedFragmentStatePagerAdapter(JActivity activity, String[] title)
    {
    ...
    public void destroyItem(ViewGroup container, int position, Object object)
    {
        ...
        JLog.d(TAG, "Removing item #" + position + ": f=" + object
